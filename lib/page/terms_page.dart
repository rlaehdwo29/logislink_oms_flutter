              ...
              children: [
                Expanded(
                    ...
                    child: Container(
                        ...
                        child: Icon(allcheck.value?Icons.check_circle:Icons.check_circle_outline_outlined,size: 28.h,color: allcheck.value?main_color:text_color_03)
                    )
                ),
                Expanded(
                    flex: 12,
                            ...
                            child: Row(
                              children: [
                                Expanded(
                                    ...
                                    child:Container(
                                        margin: EdgeInsets.symmetric(horizontal: CustomStyle.getWidth(10.0)),
                                        child: Icon(checkBoxArrayList.value[0]?Icons.check_circle:Icons.check_circle_outline_outlined,size: 28.h,color: checkBoxArrayList.value[0]?main_color:text_color_03)
                                    )
                                ),
                                Expanded(
                                    flex: 10,
