...
import 'package:logislink_oms_flutter/common/model/notice_model.dart';
...
import 'package:logislink_oms_flutter/page/subPage/appbar_notice_detail_page.dart';
    ...
    return mList.isNotEmpty
          ...
          child: Center(
              child: Text(
                ...
                style: CustomStyle.CustomFont(styleFontSize20, light_gray3),
              )),
        );
  }
