...
import 'package:logislink_oms_flutter/page/subPage/webview_page.dart';
...
class _AppBarSettingPageState extends State<AppBarSettingPage> {
  ...
  Future<void> goToTrans() async {
    Map<String,dynamic> results = await Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context) => OrderTransInfoPage(
      order_vo:mOrderOption.value,
      unit_charge_local: mOrderOption.value.buyCharge??"",
      code: Const.RESULT_SETTING_TRANS,
    )));
        ...
        InkWell(
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                Text(
                  Strings.of(context)?.get("setting_order_trans")??"운송 정보 설정_",
                  style: CustomStyle.CustomFont(styleFontSize14, text_color_01),
                ),
                Container(
                    padding: EdgeInsets.only(left: CustomStyle.getWidth(10.0.w)),
