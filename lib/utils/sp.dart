...
class SP extends GetxController {
   ...
   * 저장된 공통코드 목록 불러오기
   */
  static Future<List<CodeModel>> getCodeList(String key) async {
    Logger logger = Logger();
   ...
   */
  static Future<String> getCodeName(String key, String val) async {
    if (val.isEmpty) {
      return "";
    }
    List<CodeModel>? list = await getCodeList(key);
    String codeName = "";
