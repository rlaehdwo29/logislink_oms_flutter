...
import 'package:logislink_oms_flutter/common/common_main_widget.dart';
import 'package:logislink_oms_flutter/common/common_util.dart';
import 'package:logislink_oms_flutter/common/config_url.dart';
...
import 'package:logislink_oms_flutter/db/appdatabase.dart';
import 'package:logislink_oms_flutter/page/notification_page.dart';
import 'package:logislink_oms_flutter/page/subPage/appbar_monitor_page.dart';
import 'package:logislink_oms_flutter/page/subPage/appbar_mypage.dart';
import 'package:logislink_oms_flutter/page/subPage/appbar_notice_page.dart';
import 'package:logislink_oms_flutter/page/subPage/appbar_setting_page.dart';
import 'package:logislink_oms_flutter/page/subPage/order_detail_page.dart';
import 'package:logislink_oms_flutter/page/subPage/reg_order/regist_order_page.dart';
import 'package:logislink_oms_flutter/provider/code_service.dart';
...
class _MainPageState extends State<MainPage> with CommonMainWidget,WidgetsBindingObserver {
  ...
  static const SCREEN_ORDER_REG = "오더등록";
  static const SCREEN_MONITOR = "실적현황";
  ...
  Future<void> getOrder() async {
    ...
    await DioService.dioClient(header: true).getOrder(
      ...
      logger.d("main_page.dart getOrder() _response -> ${_response.status} // ${_response.resultMap}");
        ...
        if(_response.resultMap?["result"] == true) {
          if (_response.resultMap?["data"] != null) {
            try {
              ...
              print("main_page.dart getOrder() Exception => $e");
            }
          }
        }else{
      ...
      switch (obj.runtimeType) {
        ...
        // Here's the sample to get the failed response error code and message
          ...
          print("main_page.dart getOrder() Error => ${res?.statusCode} // ${res?.statusMessage}");
          break;
        default:
          print("main_page.dart getOrder() getOrder Default => ");
          break;
      }
    });
  }
  ...
  void handleDeepLink() async {
    ...
    FirebaseDynamicLinks.instance.getInitialLink().then(
          ...
          if (dynamicLinkData != null) {
            ...
            String? allocId = deepLink.queryParameters["orderId"];
            if(allocId == null) return;
            switch(code) {
              case "order":
                Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context) => OrderDetailPage(orderId: orderId)));
                break;
            }
          }else{
            return;
  ...
  Future<void> goToPoint() async {
    //Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context) => PointPage()));
  }
        ...
        child: ListView(
          ...
          children: [
            ...
            ListTile(
              ...
              onTap: (){
                Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context) => AppBarMyPage()));
              },
            ),
            ListTile(
              contentPadding: EdgeInsets.symmetric(vertical: CustomStyle.getHeight(5.h),horizontal: CustomStyle.getWidth(5.w)),
                ...
                child: Column(children: [
                  Container(
                      ...
                      child: Column(
                        ...
                        item.driverId != null && item.driverId?.isEmpty == false? CustomStyle.sizedBoxHeight(3.0.h):const SizedBox(),
                        item.driverId != null && item.driverId?.isEmpty == false? CustomStyle.getDivider1():const SizedBox(),
                        item.driverId != null && item.driverId?.isEmpty == false? CustomStyle.sizedBoxHeight(3.0.h):const SizedBox(),
                        item.driverId != null && item.driverId?.isEmpty == false?
                        Container(
                            decoration: CustomStyle
                                .baseBoxDecoWhite(),
                            child: Row(children: [
                        ...
                        item.driverId != null && item.driverId?.isEmpty == false? CustomStyle.sizedBoxHeight(5.0.h):const SizedBox(),
                        item.driverId != null && item.driverId?.isEmpty == false? CustomStyle.getDivider1(): const SizedBox(),
                        item.driverId != null && item.driverId?.isEmpty == false? CustomStyle.sizedBoxHeight(5.0.h): const SizedBox(),
                        Container(
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
            InkWell(
              onTap: () {
                ShowCodeDialogWidget(context:context, mTitle: Strings.of(context)?.get("order_state")??"", codeType: Const.ORDER_STATE_CD,mFilter: "", callback: selectItem).showDialog();
              },
              child: Container(
                  padding: EdgeInsets.symmetric(
