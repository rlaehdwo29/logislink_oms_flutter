...
import 'package:logislink_oms_flutter/common/model/version_model.dart';
...
import 'package:logislink_oms_flutter/page/login_page.dart';
import 'package:logislink_oms_flutter/page/main_page.dart';
import 'package:logislink_oms_flutter/page/permission_page.dart';
  ...
  Future<void> getUserInfo() async {
    ...
    await DioService.dioClient(header: true).getUserInfo(nowUser?.authorization).then((it) async {
      ...
      switch (obj.runtimeType) {
        ...
        // Here's the sample to get the failed response error code and message
          final res = (obj as DioError).response;
          print("bridge_page.dart getUserInfo() Exception=> ${res?.statusCode} // ${res?.statusMessage}");
          break;
        default:
          print("bridge_page.dart getUserInfo() Default Exception => ");
          break;
      }
    });
